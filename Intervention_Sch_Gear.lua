...
function init_gear_sets()
    ...
    sets.MagicBurst = {main="Akademos",neck="Mizu. Kubikazari",hands="Amalric Gages +1",ring1="Mujin Band",ring2="Locus Ring",feet="Jhakri Pigaches +1"}
    ...
    sets.midcast.Kaustra = {main="Akademos",sub="Niobid Strap",ammo="Pemphredo Tathlum",
        ...
        body="Jhakri Robe +2", hands="Amalric Gages +1",ring1="Shiva Ring +1",ring2="Archon Ring",
