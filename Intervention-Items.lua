...
gear.herculean_ta_legs = {name="Herculean Trousers",augments={'Accuracy+10 Attack+10','"Triple Atk."+4','AGI+10','Accuracy+15',}}
...
gear.merlinic_burst_feet ={ name="Merlinic Crackows", augments={'Mag. Acc.+8 "Mag.Atk.Bns."+8','Magic burst dmg.+11%','MND+4','"Mag.Atk.Bns."+7',}}
