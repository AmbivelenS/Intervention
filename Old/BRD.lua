...
function init_gear_sets()
    ...
    -- Precast Sets
	main = {}
	main.PDT = {name = "Izhiikoh"}
	
	shield = {}
	shield.PDT = {name = "Genbu's Shield"}


    -- Fast cast sets for spells
    sets.precast.FC = {head="Nahtirah Hat",ear2="Loquac. Earring",
        hands="Gendewitha Gages",ring1="Prolix Ring",
        back="Swith Cape",waist="Witful Belt",legs="Aya. Cosciales +1",feet="Chelona Boots +1"}
    ...
    sets.precast.FC.BardSong = {main="Felibre's Dague",range="Eminent Flute",
        head="Fili Calot",neck="Moonbow Whistle",ear1="Fili Earring",ear2="Loquac. Earring",
        body="Sha'ir Manteel",hands="Gendewitha Gages",ring1="Prolix Ring",
        back="Swith Cape",waist="Witful Belt",legs="Aya. Cosciales +1",feet="Bihu Slippers"}
    ...
    sets.midcast.FastRecast = {range="Angel Lyre",
        ...
        back="Swith Cape",waist="Goading Belt",legs="Gendewitha Spats",feet="Brioso Slippers +1"}
    ...
    sets.midcast.SongEffect = {main="Legato Dagger",range="Eminent Flute",
        head="Fili Calot",neck="Moonbow Whistle",ear2="Loquacious Earring",
        body="Fili Hongreline",hands="Fili Manchettes",ring1="Prolix Ring",ring2="Gelatinous Ring +1",
        back="Harmony Cape",waist="Corvax Sash",legs="Inyanga Shalwar",feet="Brioso Slippers +1"}

    -- For song defbuffs (duration primary, accuracy secondary)
    sets.midcast.SongDebuff = {main=main.PDT,sub=shield.PDT,range="Eminent Flute",
        head="Brioso Roundlet +1",neck="Moonbow Whistle",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Brioso Just. +1",hands="Brioso Cuffs +2",ring1="Prolix Ring",ring2="Gelatinous Ring +1",
        back="Kumbira Cape",waist="Goading Belt",legs="Brioso Cann. +1",feet="Aya. Gambieras"}

    -- For song defbuffs (accuracy primary, duration secondary)
    sets.midcast.ResistantSongDebuff = {main=main.PDT,sub=shield.PDT,range="Eminent Flute",
        head="Brioso Roundlet +1",neck="Wind Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
        body="Brioso Justaucorps +1",hands="Fili Manchettes",ring1="Prolix Ring",ring2="Gelatinous Ring +1",
        back="Kumbira Cape",waist="Demonry Sash",legs="Brioso Cannions +1",feet="Aya. Gambieras"}
    ...
    sets.idle.other = {main=main.PDT, sub=shield.PDT,range="Oneiros Harp",
        ...
        back="Umbra Cape",waist="Flume Belt",legs="Nares Trews",feet="Fili Cothurnes"}

    sets.idle = {main=main.PDT, sub=shield.PDT,range="Oneiros Harp",
        head="Aya. Zucchetto",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Ayanmo Corazza +1",feet="Aya. Gambieras",ring1="Defending Ring",ring2="Sangoma Ring",
        back="Umbra Cape",waist="Flume Belt",legs="Ayanmo Cosciales",feet="Fili Cothurnes"}

    sets.idle.Town = {main=main.PDT, sub=shield.PDT,range="Oneiros Harp",
        head="Gendewitha Caubeen",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Paguroidea Ring",ring2="Sangoma Ring",
        back="Umbra Cape",waist="Flume Belt",legs="Nares Trews",feet="Fili Cothurnes"}
    
    sets.idle.Weak = {main=main.PDT,sub=shield.PDT,range="Oneiros Harp",
    ...
    sets.defense.PDT = {main=main.PDT,sub=shield.PDT,
        head="Gendewitha Caubeen",neck="Twilight Torque",
        body="Gendewitha Bliaut",hands="Gendewitha Gages",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Umbra Cape",waist="Flume Belt",legs="Gendewitha Spats",feet="Gendewitha Galoshes"}

    sets.defense.MDT = {main=main.PDT,sub=shield.PDT,
