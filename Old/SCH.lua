...
function init_gear_sets()
    ...
    sets.midcast['Dark Magic'] = {main="Lehbrailg +2",sub="Willpower Grip",ammo="Incantor Stone",
    ...
    sets.midcast['Elemental Magic'].HighTierNuke = set_combine(sets.midcast['Elemental Magic'], {sub="Willpower Grip"})

    sets.midcast['Elemental Magic'].HighTierNuke.Resistant = set_combine(sets.midcast['Elemental Magic'].Resistant, {sub="Willpower Grip"})
    ...
    -- Resting sets
    sets.resting = {main="Pluto's Staff",sub="Willpower Grip",
        head="Orvail Corona +1",neck="Wiglen Gorget",
        body="Errant Hpl.",hands="Serpentes Cuffs",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        waist="Austerity Belt",legs="Nisse Slacks",feet="Serpentes Sabots"}


    -- Idle sets (default idle set not needed since the other three are defined, but leaving for testing purposes)

 --[[ Edit this back to Town later
	sets.idle.Town = {
    ...
    sets.idle.Field.PDT = {main="Bolelabunga",sub="Genbu Shield",ammo="Incantor Stone",
    ...
    sets.defense.PDT = {main=gear.Staff.PDT,sub="Willpower Grip",ammo="Incantor Stone",
