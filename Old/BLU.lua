...
function get_sets()
	...
	TaeonBoots = {}
	TaeonBoots.Regen ={ name="Rawhide Boots", augments = {'Mag. Acc.+9','"Conserve MP"+5','"Regen" potency+3',} }
	...
	HerculeanFeet.Idle = { name="Herculean Boots", augments={'DEX+9','Pet: CHR+8','"Refresh"+1','Accuracy+17 Attack+17','Mag. Acc.+12 "Mag.Atk.Bns."+12',}}
	...
	IuitlHead = {}
	IuitlHead.DT = { name = "Iuitl Headgear +1", augements = { 'Phys. dmg. taken -4%', 'Magic dmg. take -4%'}}
	...
	--TP Sets--
	sets.TP = {}
	sets.TP.index = { 'DualWield', 'DualWieldCapacity', 'CappedHaste', 'DT', 'AccuracyMid', 'AccuracyFull' }
	...
	sets.TP.DualWieldCapacity = 
		set_combine(sets.TP.DualWield, 
		{		
			back = "Mecisto. Mantle",
		})
	...
	sets.Requiescat.Attack = {
		ammo = "Hydrocera",
		head = "Jhakri Coronal +1 +1",
		neck = "Fotia Gorget",
		ear1 = "Moonshade Earring",
		ear2 = "Brutal Earring",
		body = "Jhakri Robe +2",
		hands = "Jhakri Cuffs +2 +2",
		ring1 = "Epona's ring",
		ring2 = "Rufescent Ring",
		back = Rosmerta.WSD,
		waist = "Fotia Belt",
		legs = "Jhakri Slops +1 +1",
		feet = "Jhakri Pigaches +1 +1"
	}
	...
	sets.Expiacion.Attack = {
		...
		body="Ayanmo Corazza +1",
		hands="Jhakri Cuffs +2",
		legs={ name="Herculean Trousers", augments={'Attack+24','"Conserve MP"+5','Quadruple Attack +2','Accuracy+12 Attack+12','Mag. Acc.+2 "Mag.Atk.Bns."+2',}},
	...
	sets.Realmrazer.Attack = {
		ammo="Jukukik Feather",
    head={ name="Adhemar Bonnet", augments={'DEX+10','AGI+10','Accuracy+15',}},		body="Ayanmo Corazza +1",
		hands="Jhakri Cuffs +2",
	...
	sets.BlueMagic.INT.MAB = {
		ammo = "Pemphredo Tathlum",
		head={ name="Herculean Helm", augments={'"Mag.Atk.Bns."+29','DEX+6','Mag. Acc.+15 "Mag.Atk.Bns."+15',}},
		neck = "Eddy Necklace",
		ear1 = "Hecate's Earring",
...
send_command('bind !f9 gs c toggle Club sets')
...
send_command('bind ^numpad1 input /ma "Charged Whisker" <t>')
send_command('bind numpad2 input /ma "Whirl of Rage" <t>')
send_command('bind numpad7 input /ma "Water Bomb" <t>')
send_command('bind numpad9 input /ma "Dream Flower" <t>')
send_command('bind ^numpad9 input /ma "Sheep Song" <t>')
send_command('bind !numpad7 input /ma "Chaotic Eye" <t>')
