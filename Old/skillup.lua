...
user_settings = {
    user_spells = {
        ...
        Enhancing = T{"Barfire", "Barblizzard", "Barearo", "Barstone", "Barthunder", 'Sandstorm', 'Rainstorm', 'Windstorm', 'Firestorm', 'Hailstorm', 'Thunderstorm'},
        Ninjutsu = T{},
        Singing = T{},
        Blue = T{'Pollen'},
        Summoning = T{}},
...
sets.brd = {
    ...
    string_inst = {
        range="Eminent Flute"},}--put your string instrument here
sets.Idle = {
